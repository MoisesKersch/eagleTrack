...
/* WEBPACK VAR INJECTION */(function($) {var bt_done = null;
var dropzone = null;
...
function iniciaDropZone() {
    ...
    var myDropzone = new Dropzone("#dropZone", {
        ...
        error: function error(dados, _error) {
            alert(_error.mensagem);
            $ajusteBtnSalvarImportacao();
        ...
        success: function success(file, conflitos) {
            var dataSet = [];
            if (conflitos.length > 0) {
                for (var conflito in conflitos) {
                    ...
                    td = td + "<a title='Ignorar e Remover Ponto' class='btn btn-danger " + " bt_ignorar_conflito' value=" + conflitos[conflito].pocodigo + "'>" + "<span class='glyphicon glyphicon-trash'></span></a></td>";

                    td = td + "<a title='Sobreescrever Ponto' class='btn btn-success " + " bt_salvar_conflito ' value='" + conflitos[conflito].pocodigo + "'>" + "<span class='glyphicon glyphicon-ok'></span></a></td>";
