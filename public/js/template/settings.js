var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            ...
            +'<a href="#" data-theme="css/theme-brown.css"><img src="'+ROOT+'/img/themes/brown.jpg"/></a>'
            +'<a href="#" data-theme="css/theme-blue.css"><img src="'+ROOT+'/img/themes/blue.jpg"/></a>'
            +'<a href="#" data-theme="css/theme-white.css"><img src="'+ROOT+'/img/themes/light.jpg"/></a>'
            +'<a href="#" data-theme="css/theme-black.css"><img src="'+ROOT+'/img/themes/black.jpg"/></a>'
        +'</div>'
