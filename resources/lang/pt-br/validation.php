...
return [
    ...
    */
    ...
    'attributes' => [
        'mtnome' => 'nome',
        'name' => 'login',
        'mtperfil' => 'perfil motorista ou ajudante',
        'mtcliente' => 'cliente',
        'mtcpf' => 'CPF',
        'cldocumento' => 'Documento',
        'clnome' => 'nome',
        'clcidade' => 'cidade',
        'veplaca' => 'placa',
        'vedescricao' => 'descricão',
        'veprefixo' => 'prefixo',
        'veproprietario' => 'proprietario',
        'mocodigo' => 'Serial',
        'moimei' => 'IMEI',
        'mosim' => 'SIM',
        'usaperfil' => 'Perfil',
        'usausuario' => 'Associado',
        'usucliente' => 'Cliente',
        'usamotorista' => 'Associado',
        'password' => 'Senha',
        'descricao' => 'Descrição',
        'timkmpadrao' => 'km padrão',
        'timdescricao' => 'descrição',
        'mtjornada' => 'Jornada',
        'codigoexterno' => 'Código Externo',
        'pocodigoexterno' => 'Código externo',
        'frdescricao' => 'Descrição',
        'frdata' => 'Data',
        'frcliente' => 'Cliente',
        'frtipo' => 'Tipo',
        'phcliente' => 'Pontos horas espera',
        'gvdescricao' => 'Descrição',
        'veiculos' => 'Veiculos',
        'usuperfil' => 'Perfil'
    ],
